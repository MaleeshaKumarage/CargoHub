...
using HiavaNet.Api.Options;
using HiavaNet.Application.Auth.Abstractions;
using HiavaNet.Application.Auth.Handlers;
using HiavaNet.Application.Bookings;
using HiavaNet.Application.Company;
using HiavaNet.Infrastructure.Auth;
using HiavaNet.Infrastructure.Couriers;
...
builder.Services.AddDbContext<ApplicationDbContext>(options =>
{
    options.UseNpgsql(connectionString, npgsql =>
        npgsql.MigrationsAssembly("HiavaNet.Infrastructure"));
});
...
builder.Services.AddMediatR(typeof(HiavaNet.Application.AssemblyMarker).Assembly);
...
builder.Services.AddSingleton<HiavaNet.Api.Services.WaybillPdfGenerator>();
...
using (var scope = app.Services.CreateScope())
{
    ...
    foreach (var roleName in new[] { HiavaNet.Application.Auth.RoleNames.SuperAdmin, HiavaNet.Application.Auth.RoleNames.Admin, HiavaNet.Application.Auth.RoleNames.User })
    {
