...
public class PortalController : ControllerBase
{
    ...
    [HttpGet("me")]
    [Authorize]
    public async Task<ActionResult<HiavaNet.Application.Auth.Dtos.PortalMeResponse>> Me(CancellationToken cancellationToken)
    {
        ...
        return Ok(new HiavaNet.Application.Auth.Dtos.PortalMeResponse
        {
            UserId = userId,
            Email = email ?? "",
