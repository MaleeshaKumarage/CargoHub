...
export default async function TourPage({ params }: Props) {
  ...
  return (
    <main className="relative">
      <section
        id="top"
        className="mx-auto max-w-6xl px-4 pb-20 pt-12 sm:px-6 sm:pt-16 lg:px-8 lg:pt-20"
      >
        <RevealOnScroll>
          ...
          <p className="mt-6 max-w-2xl text-lg text-zinc-400">{tHero("subtitle")}</p>
          ...
          <ul className="mt-14 flex flex-wrap gap-6 border-t border-cyan-500/15 pt-8 font-mono text-xs text-zinc-500">
      ...
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <RevealOnScroll>
            ...
            <h2 className="mt-2 max-w-2xl text-3xl font-semibold tracking-tight text-zinc-50 sm:text-4xl">
              {tPlat("title")}
            </h2>
            <p className="mt-4 max-w-2xl text-zinc-400">{tPlat("intro")}</p>
            <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div
                  key={card.title}
                  className="rounded-xl border border-cyan-500/15 bg-zinc-900/40 p-5 backdrop-blur-sm transition-colors hover:border-cyan-500/30"
                >
      ...
      <section id="bookings" className="py-20 sm:py-24">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <RevealOnScroll>
            ...
            <ul className="mt-6 space-y-2 font-mono text-sm text-cyan-200/90">
              <li>— {tBook("b1")}</li>
              <li>— {tBook("b2")}</li>
              <li>— {tBook("b3")}</li>
            </ul>
      ...
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <RevealOnScroll className="grid gap-10 lg:grid-cols-3 lg:items-center">
      ...
      <section id="admin" className="py-16 sm:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <RevealOnScroll className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
      ...
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <RevealOnScroll>
            ...
            <ol className="mt-8 space-y-4 font-mono text-sm text-zinc-300">
            ...
            <p className="mt-8 max-w-xl border-l-2 border-cyan-500/40 pl-4 text-sm text-zinc-500">
              {tStart("faq")}
            </p>
