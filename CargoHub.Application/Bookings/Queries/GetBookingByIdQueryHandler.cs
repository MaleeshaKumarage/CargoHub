...
public sealed class GetBookingByIdQueryHandler : IRequestHandler<GetBookingByIdQuery, BookingDetailDto?>
{
    ...
    public static BookingDetailDto MapToDetail(CargoHub.Domain.Bookings.Booking b)
    {
        return Map(b);
    }

    private static BookingDetailDto Map(CargoHub.Domain.Bookings.Booking b)
    {
    ...
    private static BookingShipmentDto? MapShipment(CargoHub.Domain.Bookings.BookingShipment? s)
    {
    ...
    private static BookingShippingInfoDto? MapShippingInfo(CargoHub.Domain.Bookings.ShippingInfo? s)
    {
        if (s == null) return null;
    ...
    private static BookingPackageDto MapPackage(CargoHub.Domain.Bookings.BookingPackage p)
    {
    ...
    private static BookingPartyDto? MapParty(CargoHub.Domain.Bookings.BookingParty? p)
    {
